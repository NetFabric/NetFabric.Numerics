...
public readonly struct AddValueOperation<T> 
    ...
    where T : struct, IAdditionOperators<T, T, T>
{
    ...
    public AddValueOperation(T value) 
    {
        this.value = value;
...
[StructLayout(LayoutKind.Auto)]
public readonly struct AddValueOperation2D<T> 
    ...
    where T : struct, IAdditionOperators<T, T, T>
{
    ...
    public AddValueOperation2D(T value1, T value2) 
    {
        this.value1 = value1;
        this.value2 = value2;
...
public readonly struct AddOperation<T> 
