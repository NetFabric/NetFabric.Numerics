...
static class Vector2Extensions
{
    ...
    public static Vector64<uint> AsVector64(this in Vector2<uint> vector)
        => Unsafe.As<Vector2<uint>, Vector64<uint>>(ref Unsafe.AsRef(in vector));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector64<int> AsVector64(this in Vector2<int> vector)
        => Unsafe.As<Vector2<int>, Vector64<int>>(ref Unsafe.AsRef(in vector));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector64<float> AsVector64(this in Vector2<float> vector)
        => Unsafe.As<Vector2<float>, Vector64<float>>(ref Unsafe.AsRef(in vector));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector128<uint> AsVector128(this in Vector2<uint> vector)
        => new Vector4<uint>(vector.X, vector.Y, 0, 0).AsVector128();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector128<int> AsVector128(this in Vector2<int> vector)
        => new Vector4<int>(vector.X, vector.Y, 0, 0).AsVector128();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector128<float> AsVector128(this in Vector2<float> vector)
        => new Vector4<float>(vector.X, vector.Y, 0.0f, 0.0f).AsVector128();

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector128<ulong> AsVector128(this in Vector2<ulong> vector)
        => Unsafe.As<Vector2<ulong>, Vector128<ulong>>(ref Unsafe.AsRef(in vector));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector128<long> AsVector128(this in Vector2<long> vector)
        => Unsafe.As<Vector2<long>, Vector128<long>>(ref Unsafe.AsRef(in vector));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector128<double> AsVector128(this in Vector2<double> vector)
        => Unsafe.As<Vector2<double>, Vector128<double>>(ref Unsafe.AsRef(in vector));
