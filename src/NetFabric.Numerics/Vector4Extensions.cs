...
static class Vector4Extensions
{
    ...
    public static Vector64<ushort> AsVector64(this in Vector4<ushort> vector)
        => Unsafe.As<Vector4<ushort>, Vector64<ushort>>(ref Unsafe.AsRef(in vector));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector64<short> AsVector64(this in Vector4<short> vector)
        => Unsafe.As<Vector4<short>, Vector64<short>>(ref Unsafe.AsRef(in vector));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector64<Half> AsVector64(this in Vector4<Half> vector)
        => Unsafe.As<Vector4<Half>, Vector64<Half>>(ref Unsafe.AsRef(in vector));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector128<ushort> AsVector128(this in Vector4<ushort> vector)
        => Vector128.Create(vector.X, vector.Y, vector.Z, vector.W, 0, 0, 0, 0);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector128<short> AsVector128(this in Vector4<short> vector)
        => Vector128.Create(vector.X, vector.Y, vector.Z, vector.W, 0, 0, 0, 0);

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector128<uint> AsVector128(this in Vector4<uint> vector)
        => Unsafe.As<Vector4<uint>, Vector128<uint>>(ref Unsafe.AsRef(in vector));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector128<int> AsVector128(this in Vector4<int> vector)
        => Unsafe.As<Vector4<int>, Vector128<int>>(ref Unsafe.AsRef(in vector));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector128<float> AsVector128(this in Vector4<float> vector)
        => Unsafe.As<Vector4<float>, Vector128<float>>(ref Unsafe.AsRef(in vector));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector256<ulong> AsVector256(this in Vector4<ulong> vector)
        => Unsafe.As<Vector4<ulong>, Vector256<ulong>>(ref Unsafe.AsRef(in vector));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector256<long> AsVector256(this in Vector4<long> vector)
        => Unsafe.As<Vector4<long>, Vector256<long>>(ref Unsafe.AsRef(in vector));

    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector256<double> AsVector256(this in Vector4<double> vector)
        => Unsafe.As<Vector4<double>, Vector256<double>>(ref Unsafe.AsRef(in vector));
