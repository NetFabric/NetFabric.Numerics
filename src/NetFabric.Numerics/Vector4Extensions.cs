...
static class Vector4Extensions
{
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector64<T> ToVector64<T>(this in Vector4<T> vector)
    where T : struct, INumber<T>, IMinMaxValue<T>
        => Vector64.LoadUnsafe<T>(ref Unsafe.As<Vector4<T>, T>(ref Unsafe.AsRef(in vector)));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector128<T> ToVector128<T>(this in Vector4<T> vector)
    where T : struct, INumber<T>, IMinMaxValue<T>
        => Vector128.LoadUnsafe<T>(ref Unsafe.As<Vector4<T>, T>(ref Unsafe.AsRef(in vector)));
    ...
    [MethodImpl(MethodImplOptions.AggressiveInlining)]
    public static Vector4<T> ToVector4<T>(this ref Vector128<T> vector)
        where T : struct, INumber<T>, IMinMaxValue<T>
    {
