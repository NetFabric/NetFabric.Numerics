    ...
    public static TheoryData<Vector<double>[], Vector<double>[], Vector<double>[]> AddVectorData
        => new()
        {
            ...
            },
            {
                ...
                new[] { new Vector<double>(4.0, 6.0, 8.0) }
            },
            {
                ...
                new[] { new Vector<double>(4.0, 6.0, 8.0), new Vector<double>(13.0, 15.0, 17.0) }
            },
            {
                ...
                Enumerable.Range(0, 97).Select(value => new Vector<double>((value + 10.0) + (value * 0.5), (value - 5.0) - value, (value + 2.0) + (value - 3.0))).ToArray()
            },
        };
