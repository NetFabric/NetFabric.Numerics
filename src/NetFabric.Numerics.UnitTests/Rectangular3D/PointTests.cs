...
public class PointTests
{
    ...
    public static TheoryData<Point<double>, Spherical.Point<Degrees, double>> ToSphericalData => new()
        {
            ...
            { new(1.0,  1.0, 0.0),  new(sqrt2, new(45.0),  new(90.0)) },
            { new(0.0,  1.0, 0.0),  new(1.0,  new(90.0),  new(90.0)) },
            { new(-1.0, 1.0, 0.0),  new(sqrt2, new(135.0), new(90.0)) },
            { new(-1.0, 0.0, 0.0),  new(1.0,  new(180.0), new(90.0)) },
            { new(-1.0, -1.0, 0.0), new(sqrt2, new(225.0), new(90.0)) },
            { new(0.0,  -1.0, 0.0), new(1.0,  new(270.0), new(90.0)) },
            { new(1.0,  -1.0, 0.0), new(sqrt2, new(315.0), new(90.0)) },
    ...
    public void ToSpherical_Should_Succeed(Point<double> point, Spherical.Point<Degrees, double> expected)
    {
        // arrange
