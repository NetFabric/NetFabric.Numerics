    ...
    where TRadius: struct, IFloatingPoint<TRadius>
{
    ...
    ICoordinateSystem IVector<Vector<TAngle, TRadius>>.CoordinateSystem => CoordinateSystem;
    ...
    public static Vector<TAngle, TRadius> AdditiveIdentity => new (TAngle.AdditiveIdentity, TAngle.AdditiveIdentity, TRadius.AdditiveIdentity);
